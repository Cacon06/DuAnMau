...
public class Dbhepler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
            ...
            String insertThuThu = "INSERT INTO Thuthu VALUES('admin','admin','admin');";
            sqLiteDatabase.execSQL(insertThuThu);
            ...
            String createTbLoaiSach="CREATE TABLE LoaiSach (    MaLoaiSach  INTEGER PRIMARY KEY AUTOINCREMENT,TenLoaiSach TEXT    NOT NULL,tentg TEXT    NOT NULL);";
            sqLiteDatabase.execSQL(createTbLoaiSach);
            String createTbSach="CREATE TABLE Sach ( MaSach  INTEGER PRIMARY KEY AUTOINCREMENT, TenSach TEXT    NOT NULL, GiaThue INTEGER NOT NULL, namxb INTEGER NOT NULL, MaLoai  INTEGER REFERENCES LoaiSach (MaLoaiSach) );";
